...
public class DestinationStatsUnitTest {
    ...
    @Test
    public void testDestinationMetrics() throws Exception {
        MetricsHelper.testMetric("destinationstats", (ModelCamelContext) context, jolokiaMock, hawkularMock);
    }
