...
/**
 * Created by wisyzi on 18/08/2016.
 */

def content = new File("/Users/swinchester/GitHub/swinchester-metrics/hawkular-metrics-collectj/metrics-collectj/src/test/resources/destinationmetrics/expectedHawkularRequest-body.json").text

println generateBody(content)
